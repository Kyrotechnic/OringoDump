...
public abstract class PlayerSPMixin extends AbstractClientPlayerMixin
{
            ...
            if (!this.isInWater() || (((Entity)this) instanceof EntityPlayer && this.capabilities.isFlying)) {
                if (!this.isInLava() || (((Entity)this) instanceof EntityPlayer && this.capabilities.isFlying)) {
                    ...
                    if (this.isOnLadder()) {
                        ...
                        final boolean flag = this.isSneaking() && ((Entity)this) instanceof EntityPlayer;
                ...
                float f8 = 0.8f;
                float f9 = 0.02f;
                float f10 = (float)EnchantmentHelper.getDepthStriderModifier((Entity)this);
                if (f10 > 3.0f) {
                    f10 = 3.0f;
                }
                if (!this.onGround) {
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        if (this.noClip) {
            ...
            final double d5 = y;
            double d6 = z;
            final boolean flag = ((this.onGround && this.isSneaking()) || (PlayerUtils.isOnGround(1.0) && OringoClient.scaffold.isToggled() && Scaffold.safeWalk.isEnabled())) && ((Entity)this) instanceof EntityPlayer;
            if (flag) {
    ...
    public void attackTargetEntityWithCurrentItem(final Entity targetEntity) {
        if (ForgeHooks.onPlayerAttackTarget((EntityPlayer)this, targetEntity) && targetEntity.canAttackWithItem() && !targetEntity.hitByEntity((Entity)this)) {
