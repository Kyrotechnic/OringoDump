...
public class Gui extends Module
{
    ...
    public void onRender(final RenderGameOverlayEvent.Post event) {
        if (event.type == RenderGameOverlayEvent.ElementType.CROSSHAIRS) {
            ...
            if (this.arrayList.isEnabled()) {
                ...
                final List<Module> list = (List<Module>)OringoClient.modules.stream().filter(module -> module.getCategory() != Category.RENDER && module.getCategory() != Category.KEYBINDS && (module.isToggled() || module.toggledTime.getTimePassed() <= 250L)).sorted(Comparator.comparingDouble(module -> font.getStringWidth(module.getName()))).collect(Collectors.toList());
    ...
    public float getHeight() {
        ...
        final List<Module> list = (List<Module>)OringoClient.modules.stream().filter(module -> module.getCategory() != Category.RENDER && module.getCategory() != Category.KEYBINDS && (module.isToggled() || module.toggledTime.getTimePassed() <= 250L)).sorted(Comparator.comparingDouble(module -> Fonts.tahomaSmall.getStringWidth(module.getName()))).collect(Collectors.toList());
        float y = 3.0f;
        for (final Module module2 : list) {
