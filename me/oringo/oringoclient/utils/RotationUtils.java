...
public class RotationUtils
{
    ...
    public static Rotation getClosestRotation(final AxisAlignedBB aabb) {
        return getRotations(getClosestPointInAABB(OringoClient.mc.thePlayer.getPositionEyes(1.0f), aabb));
    }
    ...
    public static Rotation getScaffoldRotations(final BlockPos position) {
        ...
        final double x = position.getX() - OringoClient.mc.thePlayer.posX - posX;
        final double y = position.getY() - OringoClient.mc.thePlayer.prevPosY - OringoClient.mc.thePlayer.getEyeHeight();
        final double z = position.getZ() - OringoClient.mc.thePlayer.posZ - posZ;
    ...
    public static Rotation getRotations(final double posX, final double posY, final double posZ) {
        final double x = posX - OringoClient.mc.thePlayer.posX;
        final double y = posY - (OringoClient.mc.thePlayer.posY + OringoClient.mc.thePlayer.getEyeHeight());
        final double z = posZ - OringoClient.mc.thePlayer.posZ;
    ...
    public static Rotation getLastReportedRotation() {
        return new Rotation(((PlayerSPAccessor)OringoClient.mc.thePlayer).getLastReportedYaw(), ((PlayerSPAccessor)OringoClient.mc.thePlayer).getLastReportedPitch());
    }
    
    public static Rotation getPlayerRotation() {
        return new Rotation(OringoClient.mc.thePlayer.rotationYaw, OringoClient.mc.thePlayer.rotationPitch);
    }
    ...
    public static Rotation getBowRotation(final Entity entity) {
        ...
        double d = OringoClient.mc.thePlayer.getDistanceToEntity(entity);
        d -= d % 0.8;
        final double xMulti = d / 0.8 * xDelta;
        final double zMulti = d / 0.8 * zDelta;
        final double x = entity.posX + xMulti - OringoClient.mc.thePlayer.posX;
        final double z = entity.posZ + zMulti - OringoClient.mc.thePlayer.posZ;
        final double y = OringoClient.mc.thePlayer.posY + OringoClient.mc.thePlayer.getEyeHeight() - (entity.posY + entity.getEyeHeight());
        final double dist = OringoClient.mc.thePlayer.getDistanceToEntity(entity);
