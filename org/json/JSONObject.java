...
public class JSONObject
{
    ...
    public BigInteger getBigInteger(final String key) throws JSONException {
        ...
        try {
            ...
            throw new JSONException("JSONObject[" + quote(key) + "] could not be converted to BigInteger.", (Throwable)e);
        }
    }
    ...
    public BigDecimal getBigDecimal(final String key) throws JSONException {
        ...
        try {
            ...
            throw new JSONException("JSONObject[" + quote(key) + "] could not be converted to BigDecimal.", (Throwable)e);
        }
    }
    ...
    public double getDouble(final String key) throws JSONException {
        ...
        try {
            ...
            throw new JSONException("JSONObject[" + quote(key) + "] is not a number.", (Throwable)e);
        }
    }
    ...
    public int getInt(final String key) throws JSONException {
        ...
        try {
            ...
            throw new JSONException("JSONObject[" + quote(key) + "] is not an int.", (Throwable)e);
        }
    }
    ...
    public long getLong(final String key) throws JSONException {
        ...
        try {
            ...
            throw new JSONException("JSONObject[" + quote(key) + "] is not a long.", (Throwable)e);
        }
    }
