...
class AFUNIXSocketImpl extends SocketImpl
{
    ...
    private static int expectInteger(final Object value) throws SocketException {
        try {
            ...
            throw new AFUNIXSocketException("Unsupported value: " + value, (Throwable)e);
        }
        catch (NullPointerException e2) {
            throw new AFUNIXSocketException("Value must not be null", (Throwable)e2);
        }
    }
    ...
    public Object getOption(final int optID) throws SocketException {
        try {
            ...
            throw new AFUNIXSocketException("Error while getting option", (Throwable)e2);
        }
    }
    ...
    public void setOption(final int optID, final Object value) throws SocketException {
        try {
            ...
            throw new AFUNIXSocketException("Error while setting option", (Throwable)e2);
        }
    }
