...
public final class LoggerFactory
{
    ...
    private static void replayEvents() {
        final LinkedBlockingQueue<SubstituteLoggingEvent> queue = (LinkedBlockingQueue<SubstituteLoggingEvent>)LoggerFactory.SUBST_FACTORY.getEventQueue();
    ...
    static Set<URL> findPossibleStaticLoggerBinderPathSet() {
        ...
        try {
            ...
            Util.report("Error getting resources from path", (Throwable)ioe);
        }
    ...
    public static Logger getLogger(final Class<?> clazz) {
        ...
        if (LoggerFactory.DETECT_LOGGER_NAME_MISMATCH) {
            final Class<?> autoComputedCallingClass = (Class<?>)Util.getCallingClass();
    ...
    public static ILoggerFactory getILoggerFactory() {
        ...
        switch (LoggerFactory.INITIALIZATION_STATE) {
            ...
            case 4: {
                return (ILoggerFactory)LoggerFactory.NOP_FALLBACK_FACTORY;
            }
            case 2: {
                throw new IllegalStateException("org.slf4j.LoggerFactory in failed state. Original exception was thrown EARLIER. See also http://www.slf4j.org/codes.html#unsuccessfulInit");
            }
            case 1: {
                return (ILoggerFactory)LoggerFactory.SUBST_FACTORY;
            }
            default: {
