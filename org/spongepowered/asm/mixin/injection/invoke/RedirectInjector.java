...
public class RedirectInjector extends InvokeInjector
{
    ...
    protected void validateParams(final RedirectedInvoke invoke) {
        ...
        if (!invoke.returnType.equals((Object)this.returnType)) {
        ...
        for (int index = 0; index < argc; ++index) {
            ...
            final AnnotationNode coerce = Annotations.getInvisibleParameter(this.methodNode, (Class<? extends Annotation>)Coerce.class, index);
