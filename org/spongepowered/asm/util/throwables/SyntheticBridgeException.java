            ...
            case BAD_LOAD: {
                ...
                while (ia.hasNext() && ib.hasNext()) {
                    ...
                    if (na instanceof VarInsnNode && nb instanceof VarInsnNode) {
                        ...
                        printer.kv("Target " + index, "%8s %-2d %s", new Object[] { Bytecode.getOpcodeName((AbstractInsnNode)va), va.var, ta });
                        printer.kv("Incoming " + index, "%8s %-2d %s", new Object[] { Bytecode.getOpcodeName((AbstractInsnNode)vb), vb.var, tb });
